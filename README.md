...
* Container 4: Apache 2.4 + PHP 7.3 (modphp)
* Container 5: Cron
* Container 6: Varnish 5
* Container 7: Redis (volatile, cluster nodes autodiscovery)
* Container 8: Nginx SSL terminator
* Container 9: Adminer FastCGI
* Container 10: Adminer Nginx
* Container 11: Portainer
...
php bin/magento setup:install \
  ...
  --backend-frontname admin --admin-firstname AdminFirstName --admin-lastname AdminLastName --admin-email 'admin@email.com' --admin-password 'ChangeThisPassword1' --base-url 'https://magento2.docker.localhost/' --language en_US \
...
```
https://magento2.docker.localhost/
```
...
## Custom php.ini
We already have a personalized php.ini inside this project: https://github.com/nvqchau/docker-magento2-php-apache/blob/main/php.ini but if you want to further customize your settings:
